...
const services = [
  {
    icon: <Cable size={32} color="#C0392B" />,
  ...
  {
    icon: <Search size={32} color="#C0392B" />,
  ...
  {
    icon: <Rocket size={32} color="#C0392B" />,
  ...
  return (
    ...
    >
      ...
      {/* <Link
        ...
        onMouseEnter={(e) => {
          (e.currentTarget as HTMLAnchorElement).style.color = "#A93226";
        }}
        onMouseLeave={(e) => {
